...
const pillars = [
  {
    ...
    body: 'Ethereum invented the Ethereum Virtual Machine in 2015. The entire industry adopted the standard. 85% of all blockchain traffic. 31,000 developers. Every chain on EVM makes ETH more valuable.',
    stat: '85%',
      ...
      <main>
        ...
        <section className="py-24 px-6" style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6 max-w-2xl" style={{ color: '#0f172a' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-10 rounded-sm" style={{ background: '#eff6ff', border: '1px solid #bfdbfe', borderTop: '3px solid #3b6ee8' }}>
                <p className="text-xs uppercase tracking-widest mb-3" style={{ color: '#3b6ee8' }}>Metcalfe Fair Value</p>
                <p className="text-5xl font-black mb-2" style={{ color: '#0f172a' }}>$4,780</p>
                <p className="text-sm" style={{ color: '#475569' }}>At 1M daily active addresses</p>
              </div>
              <div className="p-10 rounded-sm" style={{ background: '#1e3a8a', border: '1px solid #1e3a8a', borderTop: '3px solid #6b9bf5' }}>
                ...
                <p className="text-sm" style={{ color: '#93c5fd' }}>At 1.25M daily active addresses</p>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight max-w-xl" style={{ color: '#0f172a' }}>
                  Free research. Institutional rigor. No hype.
                </h2>
                <p className="mt-4 max-w-lg leading-relaxed" style={{ color: '#475569' }}>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 bg-[#3b6ee8] hover:bg-[#1e3a8a] text-white text-sm font-semibold px-6 py-3 rounded-full transition-colors"
              >
                Subscribe free →
              </a>
            </div>
              ...
              {issues.map((item) => (
                ...
                >
                  <div className="flex items-center justify-between mb-5">
                    <span className="text-xs font-medium uppercase tracking-widest" style={{ color: '#3b6ee8' }}>{item.label}</span>
                    <span className="text-xs" style={{ color: '#94a3b8' }}>{item.date}</span>
                  </div>
                  <h3 className="text-base font-semibold leading-snug mb-3 flex-1 transition-colors group-hover:text-[#3b6ee8]" style={{ color: '#0f172a' }}>
                    {item.title}
                  </h3>
                  <p className="text-sm leading-relaxed" style={{ color: '#475569' }}>{item.excerpt}</p>
                </a>
              ))}
            </div>

            <div className="mt-8">
              <Link href="/research" className="text-sm font-medium transition-colors" style={{ color: '#3b6ee8' }}>
              ...
              {pillars.map((pillar) => (
                ...
                >
                  <div>
                    ...
                    <h3 className="text-xl md:text-2xl font-semibold tracking-tight mb-4" style={{ color: '#0f172a' }}>
                      {pillar.title}
                    </h3>
                    <p className="leading-relaxed" style={{ color: '#475569' }}>{pillar.body}</p>
                  </div>
                  <div className="md:text-right shrink-0">
                    <p className="text-5xl font-black" style={{ color: '#1e3a8a' }}>{pillar.stat}</p>
                    <p className="text-sm mt-1 md:max-w-[140px]" style={{ color: '#94a3b8' }}>{pillar.statLabel}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="py-24 px-6" style={{ borderBottom: '1px solid #e2e8f0' }}>
          <div className="max-w-6xl mx-auto">
            ...
            <p className="mb-2 max-w-2xl" style={{ color: '#475569' }}>
              Metcalfe&apos;s Law:{' '}
                  ...
                  {compassData.map((row, i) => (
                    ...
                    >
                      <td className="px-6 py-5 text-sm font-medium" style={{ color: '#0f172a' }}>
                        {row.horizon}
                        {row.current && (
                          <span className="ml-2 text-xs px-2 py-0.5 rounded-full" style={{ background: '#e2e8f0', color: '#64748b' }}>
                            baseline
                          </span>
                        )}
                      </td>
